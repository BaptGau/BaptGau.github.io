...
I've implemented a short POC repo here: **[Link to Repo]**. Note that this is still a POC. What would allow it to move to a proper feature would be, in my opinion:
